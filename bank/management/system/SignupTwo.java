	...
	public class SignupTwo extends JFrame implements ActionListener {
		...
		SignupTwo(String formno){  //constructor
			this.formno=formno;
	    	  ...
	    	  String educationValues[]= {"Non-Grauation","Graduate","Post-Graduation","Doctrate","Others"};
	    	 ...
	    	 eno=new JRadioButton("NO");
	    	  ...
	    	  add(eno);
	           ...
	           emaritalgroup.add(eno);
	                 ...
	                 next=new JButton("Next");   //adding buttons
		...
		public void actionPerformed(ActionEvent ae) {
			String sreligion=(String)religion.getSelectedItem();  //typecast
