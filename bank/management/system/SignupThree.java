...
public class SignupThree extends JFrame implements ActionListener {
	...
	SignupThree( String formno){
		...
		add(pindetail);
				...
				add(c6);
				c7=new JCheckBox("I hereby declares that the obove entered details are correct to the best of my knowledge");
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource()==submit) {
			...
			if(r1.isSelected()) {
				...
				accountType="Reccuring Deposite Type";
			}
		   ...
		   try {
			   if(accountType.equals("")) {
				   ...
				   Conn conn=new Conn();
				   String query1= "insert into signupthree values('" + formno +"','" + accountType + "','" + cardNumberStr + "','" + pinnumber + "','" + facility + "')";
				   String query2 = "insert into login values('" + formno + "','" + cardNumberStr + "','" + pinnumber + "')";
